...
_COACH_VOICE_TRAITS = (
    ...
    "Never open a response with filler affirmations such as 'Certainly!', 'Great question!', "
    "'Of course!', 'Sure!', 'Absolutely!', 'Happy to help!', or any similar preamble — "
    "jump straight into the coaching content. "
...
def ask_trainer_system(
    ...
    return (
        ...
        "- Never start with a filler affirmation (e.g. 'Certainly!', 'Great question!', 'Of course!', "
        "'Sure!', 'Absolutely!') — begin immediately with substantive coaching content.\n"
